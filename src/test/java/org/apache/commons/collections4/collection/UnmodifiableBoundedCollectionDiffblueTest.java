...
class UnmodifiableBoundedCollectionDiffblueTest {
  /**
   * Test {@link UnmodifiableBoundedCollection#unmodifiableBoundedCollection(BoundedCollection)}
   * with {@code coll}.
   *
   * <ul>
  ...
  @Test
  @DisplayName(
      "Test unmodifiableBoundedCollection(BoundedCollection) with 'coll'; given 'Element'; then return size is one")
  ...
  void testUnmodifiableBoundedCollectionWithColl_givenElement_thenReturnSizeIsOne() {
    ...
    // Act
    BoundedCollection<Object> actualUnmodifiableBoundedCollectionResult =
        UnmodifiableBoundedCollection.unmodifiableBoundedCollection((BoundedCollection<?>) coll);
  ...
  @Test
  @DisplayName(
      "Test unmodifiableBoundedCollection(BoundedCollection) with 'coll'; given 'Element'; then return size is two")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "BoundedCollection UnmodifiableBoundedCollection.unmodifiableBoundedCollection(BoundedCollection)"
   ...
   *
   * <ul>
   *   <li>When {@link CircularFifoQueue#CircularFifoQueue()}.
  ...
  @Test
  @DisplayName(
      "Test unmodifiableBoundedCollection(BoundedCollection) with 'coll'; when CircularFifoQueue(); then return Empty")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "BoundedCollection UnmodifiableBoundedCollection.unmodifiableBoundedCollection(BoundedCollection)"
  ...
  void testUnmodifiableBoundedCollectionWithColl_whenCircularFifoQueue_thenReturnEmpty() {
    ...
    BoundedCollection<Object> actualUnmodifiableBoundedCollectionResult =
        UnmodifiableBoundedCollection.unmodifiableBoundedCollection(
            (BoundedCollection<?>) new CircularFifoQueue<>());
  ...
  /**
   * Test {@link UnmodifiableBoundedCollection#unmodifiableBoundedCollection(Collection)} with
   * {@code collection}.
   *
   * <ul>
   *   <li>Given {@code 42}.
  ...
  @Test
  @DisplayName(
      "Test unmodifiableBoundedCollection(Collection) with 'collection'; given '42'; when ArrayList() add '42'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "BoundedCollection UnmodifiableBoundedCollection.unmodifiableBoundedCollection(Collection)"
  })
