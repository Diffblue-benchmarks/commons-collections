...
public class BitMapExtractorDiffblueTest {
  ...
  public void testFromBitMapArray_thenReturnNotProcessBitMapsLongPredicate() {
    // Arrange and Act
    BitMapExtractor actualFromBitMapArrayResult = BitMapExtractor.fromBitMapArray(1L, -1L, 1L, -1L);
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"BitMapExtractor BitMapExtractor.fromBitMapArray(long[])"})
  public void testFromBitMapArray_thenReturnProcessBitMapsLongPredicate() {
    // Arrange and Act
    BitMapExtractor actualFromBitMapArrayResult = BitMapExtractor.fromBitMapArray(1L, -1L, 1L, -1L);
    LongPredicate longPredicate = mock(LongPredicate.class);
  ...
  public void testFromIndexExtractor_whenTen_thenReturnNotProcessBitMapsLongPredicate() {
    // Arrange
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"BitMapExtractor BitMapExtractor.fromIndexExtractor(IndexExtractor, int)"})
  public void testFromIndexExtractor_whenTen_thenReturnProcessBitMapsLongPredicate() {
    // Arrange
    IndexExtractor extractor = mock(IndexExtractor.class);
    when(extractor.processIndices(Mockito.<IntPredicate>any())).thenReturn(true);
  ...
  public void testAsBitMapArray_thenReturnArrayOfLongWithZero() {
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"long[] BitMapExtractor.asBitMapArray()"})
  public void testAsBitMapArray_thenReturnArrayOfLongWithZeroAndZero() {
    // Arrange, Act and Assert
    assertArrayEquals(
  ...
  public void testProcessBitMapPairs() {
    // Arrange
