...
class TransformedSetDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test transformingSet(Set, Transformer); given '42'; when HashSet() add '42'; then return HashSet()")
  @Tag("MaintainedByDiffblue")
   ...
   */
  @Test
  @DisplayName("Test transformingSet(Set, Transformer); given two; when HashSet() add two; then return HashSet()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"TransformedSet TransformedSet.transformingSet(Set, Transformer)"})
   ...
   */
  @Test
  @DisplayName("Test new TransformedSet(Set, Transformer); given '42'; when HashSet() add '42'; then return HashSet()")
  @Tag("MaintainedByDiffblue")
   ...
   */
  @Test
  @DisplayName("Test new TransformedSet(Set, Transformer); given two; when HashSet() add two; then return HashSet()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void TransformedSet.<init>(Set, Transformer)"})
