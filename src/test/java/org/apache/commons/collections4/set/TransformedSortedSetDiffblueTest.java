...
public class TransformedSortedSetDiffblueTest {
  /**
  ...
  public void testTransformedSortedSet_givenApply_thenCallsApply() {
    // Arrange
  ...
  public void testTransformingSortedSet_given42_whenTreeSetAdd42_thenReturnTreeSet() {
    // Arrange
    TreeSet<Object> set = new TreeSet<>();
    set.add("42");
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"TransformedSortedSet TransformedSortedSet.transformingSortedSet(SortedSet, Transformer)"})
  public void testTransformingSortedSet_givenFoo_whenTreeSetAddFoo_thenReturnTreeSet() {
    // Arrange
    TreeSet<Object> set = new TreeSet<>();
    set.add("foo");
    set.add("42");
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"TransformedSortedSet TransformedSortedSet.transformingSortedSet(SortedSet, Transformer)"})
  public void testTransformingSortedSet_whenTreeSet_thenReturnTreeSet() {
    // Arrange
    TreeSet<Object> set = new TreeSet<>();
  ...
  public void testNewTransformedSortedSet_given42_whenTreeSetAdd42_thenReturnTreeSet() {
    // Arrange
    TreeSet<Object> set = new TreeSet<>();
    set.add("42");
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void TransformedSortedSet.<init>(SortedSet, Transformer)"})
  public void testNewTransformedSortedSet_givenFoo_whenTreeSetAddFoo_thenReturnTreeSet() {
    // Arrange
    TreeSet<Object> set = new TreeSet<>();
    set.add("foo");
    set.add("42");
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void TransformedSortedSet.<init>(SortedSet, Transformer)"})
  public void testNewTransformedSortedSet_whenTreeSet_thenReturnTreeSet() {
    // Arrange
    TreeSet<Object> set = new TreeSet<>();
