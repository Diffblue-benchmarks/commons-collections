...
public class PatriciaTrieDiffblueTest {
  ...
  public void testNewPatriciaTrie_givenEmptyString_whenHashMapEmptyStringIs42() {
    // Arrange
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void PatriciaTrie.<init>(Map)"})
  public void testNewPatriciaTrie_givenKeyAnalyzer_whenHashMap42Is42_thenReturn42() {
    // Arrange
    HashMap<String, Object> map = new HashMap<>();
    map.put("42", "42");
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void PatriciaTrie.<init>(Map)"})
  public void testNewPatriciaTrie_givenKeyAnalyzer_whenHashMapKeyAnalyzerIs42() {
    // Arrange
    HashMap<String, Object> map = new HashMap<>();
    map.put("keyAnalyzer", "42");
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void PatriciaTrie.<init>(Map)"})
  public void testNewPatriciaTrie_givenKey_whenHashMap42Is42_thenReturnHashMap() {
    // Arrange
    HashMap<String, Object> map = new HashMap<>();
    map.put("42", "42");
    map.put("key", "42");
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void PatriciaTrie.<init>(Map)"})
  public void testNewPatriciaTrie_givenKey_whenHashMapKeyIs42_thenReturnKeyIs42() {
    // Arrange
    HashMap<String, Object> map = new HashMap<>();
    map.put("key", "42");
    map.put("keyAnalyzer", "42");
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void PatriciaTrie.<init>(Map)"})
  public void testNewPatriciaTrie_whenHashMap_thenReturnHashMap() {
    // Arrange
    HashMap<String, Object> map = new HashMap<>();
