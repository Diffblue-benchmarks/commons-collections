...
class LazyListDiffblueTest {
   ...
   * </ul>
   *
   * <p>Method under test: {@link LazyList#lazyList(List, Factory)}
   */
  @Test
  @DisplayName(
  ...
  @Test
  @DisplayName(
      "Test lazyList(List, Factory) with 'list', 'factory'; when ArrayList(); then return ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"LazyList LazyList.lazyList(List, Factory)"})
   ...
   * </ul>
   *
   * <p>Method under test: {@link LazyList#lazyList(List, Transformer)}
   */
  @Test
  @DisplayName(
  ...
  @Test
  @DisplayName(
      "Test lazyList(List, Transformer) with 'list', 'transformer'; when ArrayList(); then return ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"LazyList LazyList.lazyList(List, Transformer)"})
  ...
  @Test
  @DisplayName(
      "Test new LazyList(List, Factory); given '42'; when ArrayList() add '42'; then return ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  void testNewLazyList_given42_whenArrayListAdd42_thenReturnArrayList() {
    ...
    // Act
    LazyList<Object> actualObjectList = new LazyList<>(list, mock(Factory.class));
  ...
  @Test
  @DisplayName(
      "Test new LazyList(List, Transformer); given '42'; when ArrayList() add '42'; then return ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  void testNewLazyList_given42_whenArrayListAdd42_thenReturnArrayList3() {
    ...
    // Act
    LazyList<Object> actualObjectList = new LazyList<>(list, mock(Transformer.class));
