...
class DualHashBidiMapDiffblueTest {
   ...
   *
   * <p>Method under test: {@link DualHashBidiMap#DualHashBidiMap()}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void DualHashBidiMap.<init>()",
    "void DualHashBidiMap.<init>(Map, Map, BidiMap)"
  })
   ...
   *
   * <p>Method under test: {@link DualHashBidiMap#DualHashBidiMap(Map)}
   */
  @Test
  ...
  void testNewDualHashBidiMap2() {
    ...
    // Act
    DualHashBidiMap<Object, Object> actualObjectObjectMap = new DualHashBidiMap<>(map);
  ...
  void testNewDualHashBidiMap_whenHashMap() {
    ...
    // Act
    DualHashBidiMap<Object, Object> actualObjectObjectMap =
        new DualHashBidiMap<>(normalMap, reverseMap, new DualHashBidiMap<>());
   ...
   *
   * <p>Method under test: {@link DualHashBidiMap#createBidiMap(Map, Map, BidiMap)}
   */
  @Test
