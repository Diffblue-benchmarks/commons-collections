...
class CaseInsensitiveMapDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link HashEntry} {@link HashEntry#getKey()} return fourteen.
   ...
   */
  @Test
  @DisplayName("Test clone(); given HashEntry getKey() return fourteen; then return size is three")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"CaseInsensitiveMap CaseInsensitiveMap.clone()"})
  void testClone_givenHashEntryGetKeyReturnFourteen_thenReturnSizeIsThree() {
    // Arrange
    HashEntry<Object, Object> next = mock(HashEntry.class);
    when(next.getKey()).thenReturn(14);
    ...
    assertTrue(actualCloneResult.containsKey(null));
    assertSame(AbstractHashedMap.NULL, actualCloneResult.get("14"));
  }
