...
class TransformedMapDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test transformedMap(Map, Transformer, Transformer); given '42'; when HashMap() '42' is NULL; then HashMap() containsKey 'null'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"TransformedMap TransformedMap.transformedMap(Map, Transformer, Transformer)"})
  void testTransformedMap_given42_whenHashMap42IsNull_thenHashMapContainsKeyNull() {
    // Arrange
   ...
   */
  @Test
  @DisplayName("Test transformedMap(Map, Transformer, Transformer); given LRUMap(); when Transformer apply(Object) return LRUMap()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"TransformedMap TransformedMap.transformedMap(Map, Transformer, Transformer)"})
   ...
   */
  @Test
  @DisplayName("Test transformedMap(Map, Transformer, Transformer); given NULL; when HashMap() NULL is NULL; then HashMap() containsKey 'null'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"TransformedMap TransformedMap.transformedMap(Map, Transformer, Transformer)"})
   ...
   */
  @Test
  @DisplayName("Test transformedMap(Map, Transformer, Transformer); when HashMap(); then HashMap() Empty")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"TransformedMap TransformedMap.transformedMap(Map, Transformer, Transformer)"})
