...
class TransformedBagDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test transformedBag(Bag, Transformer); given 'Object'; when HashBag() add 'Object'; then calls apply(Object)")
   ...
   */
  @Test
  @DisplayName("Test new TransformedBag(Bag, Transformer); given 'Object'; when HashBag() add 'Object'; then return HashBag()")
  @Tag("MaintainedByDiffblue")
