...
class PredicatedSortedBagDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test predicatedSortedBag(SortedBag, Predicate); given 'true'; when Predicate test(Object) return 'true'; then calls test(Object)")
   ...
   */
  @Test
  @DisplayName("Test predicatedSortedBag(SortedBag, Predicate); when TreeBag(); then return TreeBag()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"PredicatedSortedBag PredicatedSortedBag.predicatedSortedBag(SortedBag, Predicate)"})
   ...
   */
  @Test
  @DisplayName("Test new PredicatedSortedBag(SortedBag, Predicate); given 'true'; when Predicate test(Object) return 'true'; then calls test(Object)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void PredicatedSortedBag.<init>(SortedBag, Predicate)"})
  void testNewPredicatedSortedBag_givenTrue_whenPredicateTestReturnTrue_thenCallsTest() {
    // Arrange
    TreeBag<Object> bag = new TreeBag<>();
    bag.add("Object");
    Predicate<Object> predicate = mock(Predicate.class);
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void PredicatedSortedBag.<init>(SortedBag, Predicate)"})
  void testNewPredicatedSortedBag_givenTrue_whenPredicateTestReturnTrue_thenCallsTest2() {
    // Arrange
    TreeBag<Object> bag = new TreeBag<>();
    bag.add("Object");
    bag.add("Object");
   ...
   */
  @Test
  @DisplayName("Test new PredicatedSortedBag(SortedBag, Predicate); when TreeBag(); then return TreeBag()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void PredicatedSortedBag.<init>(SortedBag, Predicate)"})
