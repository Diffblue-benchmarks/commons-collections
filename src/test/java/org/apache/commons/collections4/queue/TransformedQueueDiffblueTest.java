...
class TransformedQueueDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test transformedQueue(Queue, Transformer); when LinkedList(); then LinkedList() Empty")
   ...
   */
  @Test
  @DisplayName("Test transformingQueue(Queue, Transformer); when LinkedList(); then LinkedList() Empty")
  @Tag("MaintainedByDiffblue")
   ...
   */
  @Test
  @DisplayName("Test new TransformedQueue(Queue, Transformer); when LinkedList(); then LinkedList() Empty")
  @Tag("MaintainedByDiffblue")
