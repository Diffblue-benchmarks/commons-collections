...
class InstantiateTransformerDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test instantiateTransformer(Class[], Object[]) with 'Class[]', 'Object[]'; then return InstantiateTransformer")
   ...
   */
  @Test
  @DisplayName("Test instantiateTransformer(Class[], Object[]) with 'Class[]', 'Object[]'; then throw FunctorException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Transformer InstantiateTransformer.instantiateTransformer(Class[], Object[])"})
   ...
   */
  @Test
  @DisplayName("Test instantiateTransformer(Class[], Object[]) with 'Class[]', 'Object[]'; when empty array of Object")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Transformer InstantiateTransformer.instantiateTransformer(Class[], Object[])"})
  void testInstantiateTransformerWithClassObject_whenEmptyArrayOfObject() {
    // Arrange and Act
    Transformer<Class<?>, Object> actualInstantiateTransformerResult = InstantiateTransformer
        .instantiateTransformer(new Class[]{}, new Object[]{});
    Class<Object> forNameResult = Object.class;
    actualInstantiateTransformerResult.transform(forNameResult);
   ...
   */
  @Test
  @DisplayName("Test transform(Class) with 'Class'; given 'java.lang.Object'; then throw FunctorException")
  @Tag("MaintainedByDiffblue")
   ...
   */
  @Test
  @DisplayName("Test transform(Class) with 'Class'; given 'java.lang.Object'; when 'null'; then throw FunctorException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Object InstantiateTransformer.transform(Class)"})
