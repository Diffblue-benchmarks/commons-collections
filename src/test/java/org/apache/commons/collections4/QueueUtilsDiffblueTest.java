...
public class QueueUtilsDiffblueTest {
  ...
  public void testTransformingQueue_given42_whenLinkedListAdd42_thenReturnSizeIsOne() {
    // Arrange
    LinkedList<Object> queue = new LinkedList<>();
    queue.add("42");
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"Queue QueueUtils.transformingQueue(Queue, Transformer)"})
  public void testTransformingQueue_given42_whenLinkedListAdd42_thenReturnSizeIsTwo() {
    // Arrange
    LinkedList<Object> queue = new LinkedList<>();
    queue.add("42");
    queue.add("42");
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"Queue QueueUtils.transformingQueue(Queue, Transformer)"})
  public void testTransformingQueue_whenLinkedList_thenReturnEmpty() {
    // Arrange and Act
