...
class TiedMapEntryDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual4() {
    ...
    HashMap<Object, Object> map = new HashMap<>();
    TiedMapEntry<Object, Object> tiedMapEntry =
        new TiedMapEntry<>(map, new SimpleEntry<>("Key", "Value"));

    HashMap<Object, Object> map2 = new HashMap<>();
    map2.put("Key", "Value");
    TiedMapEntry<Object, Object> tiedMapEntry2 = new TiedMapEntry<>(map2, "Key");
    TiedMapEntry<Object, Object> tiedMapEntry3 = new TiedMapEntry<>(new HashMap<>(), tiedMapEntry2);

    // Act and Assert
    assertEquals(tiedMapEntry, tiedMapEntry3);
    assertEquals(tiedMapEntry.hashCode(), tiedMapEntry3.hashCode());
  }
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    ...
    HashMap<Object, Object> map = new HashMap<>();
    map.put("Key", "Value");
    TiedMapEntry<Object, Object> tiedMapEntry = new TiedMapEntry<>(map, "Key");
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual4() {
    ...
    // Act and Assert
    assertNotEquals(tiedMapEntry, new SimpleEntry<>("Key", "Value"));
  }
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual5() {
    // Arrange
    HashMap<Object, Object> map = new HashMap<>();
    map.put("Key", new TiedMapEntry<>(new HashMap<>(), "Key"));
    TiedMapEntry<Object, Object> tiedMapEntry = new TiedMapEntry<>(map, "Key");
