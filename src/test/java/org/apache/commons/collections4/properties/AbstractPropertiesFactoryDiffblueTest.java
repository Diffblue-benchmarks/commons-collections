...
class AbstractPropertiesFactoryDiffblueTest {
   ...
   *   <li>Then return {@code PROPERTIES}.
   * </ul>
   *
   * <p>Method under test: {@link PropertyFormat#toPropertyFormat(String)}
   */
  @Test
  @DisplayName(
      "Test PropertyFormat toPropertyFormat(String); when 'foo.txt'; then return 'PROPERTIES'")
